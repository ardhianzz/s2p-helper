                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <form action="/lembur/pengaturan_jam" method="post">
                                            ...
                                            <input type="hidden" name="jam_masuk" value="08:00:00">
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header text-white bg-primary d-flex justify-content-between">
                                ...
                                <button class="btn btn-dark text-white" data-toggle="modal" data-target="#tambahPengaturanGroup">Tambah</button>
                            </div>
    
    
    
    
                            <div class="modal fade" id="tambahPengaturanGroup" tabindex="-1" role="dialog"
                                aria-labelledby="tambahPengaturanGroup"
                                aria-hidden="true">
    
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="tambahPengaturanGroup">Edit Data Approver</h5>
                                                <button type="button" class="btn close btn-danger" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                        </div>
                                        <div class="modal-body">
                                            <form action="/lembur_settings/tambahpengaturangroup" method="POST">
                                                @csrf
                                                <div class="row mb-3">
                                                    <div class="col-md-3">Pengaturan</div>
                                                    <div class="col-md-1">:</div>
                                                    <div class="col-md-8">
                                                        <select name="nama_pengaturan" class="form-control">
                                                            <option value="Jam Masuk 07:30">Jam Masuk 07:30</option>
                                                            <option value="Jam Masuk 08:00">Jam Masuk 08:00</option>
                                                            <option value="Jam Masuk 08:30">Jam Masuk 08:30</option>
                                                            <option value="Lembur Pagi">Lembur Pagi</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group mt-5">
                                                    <input type="hidden" name="tambahPengaturanGroup" value="ture">
                                                    <button class="btn col-lg-2 btn-success" type="submit">
                                                        Tambah
                                                    </button>
                                                </div>
                                        ...
                                        <tbody>
                                            @foreach ($setting_tambahan as $i)    
                                                <tr>
                                                    ...
                                                    <td>{{ $i->pegawai_jabatan->nama }}</td>
                                                    <td>
                                                        <a href="#" data-toggle="modal" data-target="#hapusPengaturanGroup{{ $i->id }}">Hapus</a>
                                                    </td>
                                                </tr>
    
                                                <div class="modal fade" id="hapusPengaturanGroup{{ $i->id }}" tabindex="-1" role="dialog"
                                                    aria-labelledby="hapusPengaturanGroup{{ $i->id }}"
                                                    aria-hidden="true">
    
                                                    <div class="modal-dialog modal-lg" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="hapusPengaturanGroup{{ $i->id }}">Edit Data Approver</h5>
                                                                    <button type="button" class="btn close btn-danger" data-dismiss="modal" aria-label="Close">
                                                                        <span aria-hidden="true">&times;</span>
                                                                    </button>
                                                            </div>
                                                            <div class="modal-body">
                                                                <form action="/lembur_settings/hapuspengaturangroup" method="POST">
                                                                    @csrf
                                                                    <div class="row">
                                                                        <div class="col-md-3">Pengaturan</div>
                                                                        <div class="col-md-1">:</div>
                                                                        <div class="col-md-8">{{ $i->nama_pengaturan }}</div>
                                                                    </div>
    
                                                                    <div class="row">
                                                                        <div class="col-md-3">Divisi</div>
                                                                        <div class="col-md-1">:</div>
                                                                        <div class="col-md-8">{{ $i->pegawai_jabatan->nama }}</div>
                                                                    </div>
    
                                                                    <div class="form-group mt-5">
                                                                        <input type="hidden" name="hapusPengaturanGroup" value="{{ $i->id }}">
                                                                        <button class="btn col-lg-2 btn-danger" type="submit">
                                                                            Hapus
                                                                        </button>
                                                                    </div>
                                                                </form>
